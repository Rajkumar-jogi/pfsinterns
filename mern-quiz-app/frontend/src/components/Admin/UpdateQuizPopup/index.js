...
const UpdateQuizPopup = ({ isOpen, onClose, onSubmit, quiz, onInputChange, onQuestionChange, onOptionChange, onAddQuestion, onRemoveQuestion, error }) => {
    return (
        <Popup key={quiz.id} contentStyle={{ width: '90%', 'maxWidth': "1200px", 'backgroundColor': "transparent" }} open={isOpen} modal onClose={onClose}>
            <div className="custom-modal">
                ...
                <div className="content">
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <button type="button" className="button" onClick={onAddQuestion}>Add Another Question</button>
